    ...
    <form>
      ...
      <main className="flex-1 p-4 overflow-auto">
              ...
              <TableBody>
                {tablebody.map((content,rowindex) => (
                  <TableRow key={rowindex}>
                    {tableindex.map((column,columnIndex) => (
                           <TableCell className='max-w-48'>{content[tableindex[columnIndex]]}</TableCell>
                    ))}
                </TableRow>
                ))}
              </TableBody>
        ...
        <Card>
          ...
          <CardContent>
            <Textarea 
              placeholder="Enter a summary of the table data here..." 
